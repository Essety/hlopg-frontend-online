...
const [loadingBookings, setLoadingBookings] = useState(false);
  ...
  const BACKEND_URL = "http://18.61.159.40:8080";
...
useEffect(() => {
 ...
 <div className="booking-row">
    <strong>Hostel Name :</strong> {booking.hostelName}
  </div>
  

  <div className="booking-row">
    <strong>Owner Phone:</strong>{" "}
    {booking.ownerPhone ? booking.ownerPhone : "Not Available"}
  </div>
  ...
  <div className="booking-row">
    <strong>Sharing:</strong> {booking.sharingType}
  </div>
        ...
        <div className="sidebar">
          ...
          {[
            ...
            { id: "payment-history", label: "Payment History" },
              { id: "my-bookings", label: "My Bookings" },   // ✅ ADD THIS
