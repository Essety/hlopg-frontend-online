          ...
          const processedPGs = pgData.map(pg => {
            ...
            if (pg.images && pg.images.length > 0) {
              ...
              if (img.startsWith('http')) {
                ...
                displayImage = `http://18.61.159.40:8080${img}`;
              } else {
                displayImage = `http://18.61.159.40:8080/uploads/${img}`;
              }
            } else if (pg.img) {
              if (pg.img.startsWith('http')) {
                displayImage = pg.img;
              } else {
                displayImage = `http://18.61.159.40:8080${pg.img}`;
              }
            }
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((n) => (
            <div key={n.id} className="notification-card">
              <p>
                <strong>{n.studentName}</strong> booked{" "}
                <strong>{n.pgName} Hostel</strong>
              </p>
              <p>📞 {n.phone}</p>
