...
import hyderabadBg from "../assets/hyderabad.jpeg";
...
const forceUpdate = () => setForceUpdateFlag(!forceUpdateFlag);
  ...
  const getFullImageUrl = (imagePath) => {
    ...
    if (imagePath.startsWith('/uploads')) {
      return `http://18.61.159.40:8080${imagePath}`;
    }
    
    if (imagePath) {
      return `http://18.61.159.40:8080/uploads/${imagePath}`;
    }
...
// signup popup open diabled temprally
